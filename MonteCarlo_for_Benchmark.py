    ...
    def Decode(self, Chrome):
        ...
        for i in OS:
            ...
            if Operation == 0:
                ...
                Precedent_Operation_End_time = Start_End_time[Job][Operation - 1][1]  # 前驱工序结束时间
...
Processing_time, Job_Num, Machine_Num = Get_Problem(
    r'C:\Users\liuj9\Desktop\FJSSPinstances\1_Brandimarte\BrandimarteMk3.fjs')  # 路径自修改，为目标文件所在根目录
gbestpop = np.array(
